...
if __name__ == "__main__":
    ...
    ***REMOVED***_html = os.path.join(REPO_DIR, "index.html")
    if not os.path.exists(***REMOVED***_html):
        ***REMOVED***_html = r"C:\Users\SERVER\AppData\Local\Temp\porsche-digest\index.html"
    if os.path.exists(***REMOVED***_html):
        with open(***REMOVED***_html, "r", encoding="utf-8") as f:
            html = f.read()
        publish_html(html)
    else:
